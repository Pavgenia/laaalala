...
string* filtr(int n, int m, string** a, int choice4)
{
    ...
    for (int i = 0; i < n; i++)
    {
        if (stoi(a[i][0]) == choice4)
        {
            if (k == 1)
                cout << "Подробная информация о " << choice4 << " студенте: " << endl << "ФИО студента: " << a[i][1] << ", " << "Номер группы: " << a[i][2] << ", оценка: " << a[i][3] << ", название дисциплины: " << a[i][4] << endl;
            else
                cout << "ФИО студента: " << a[i][1] << ", " << "Номер группы: " << a[i][2] << ", оценка: " << a[i][3] << ", название дисциплины: " << a[i][4] << endl;
            k++;
            prove = 1;
        }
    }
